...
urlpatterns = [
    ...
    path('categorias/modificar/<int:clv>', views.modificar_categoria, name='modificar_categoria'),
    path('categorias/eliminar/<int:clv>', views.eliminar_categoria, name='eliminar_categoria'),
